...
# Run the GUI application (recommended for users)
python3 app.py
...
The system includes a user-friendly desktop application (`app.py`) that provides:

- **Directory Selection**: Browse and select source/target directories
- **One-Click Migration**: Run complete migration with progress tracking
- **Real-time Results**: View transformation details and proof certificates
- **Export Reports**: Save detailed migration reports as JSON
...
Try it with the included demo project:
- Source: `demo_project/source/`
